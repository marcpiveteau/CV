...
if recherche =='soft skills':
	if(st.button('adaptabilité')):
		st.markdown("![Alt Text](https://raw.githubusercontent.com/marcpiveteau/CV/main/adaptabilit%C3%A9.jpg)")
	...
	if(st.button('créativité')):
		st.markdown("![Alt Text](https://raw.githubusercontent.com/marcpiveteau/CV/main/creativite-personnel-1.jpg)")
	...
	if(st.button('fiabilité')):
		st.markdown("![Alt Text](https://raw.githubusercontent.com/marcpiveteau/CV/main/fiabilit%C3%A9.jpg)")
	if(st.button('intégrité')):
		st.markdown("![Alt Text](https://raw.githubusercontent.com/marcpiveteau/CV/main/integrit%C3%A9.jpg)")

st.write('----'*20)

st.markdown("<h1 style='text-align: center; color: #3283FE;font-size: 20px;'>Formation</h1>", unsafe_allow_html=True)
recherche2 = st.selectbox("Que souhaitez vous voir dans mon parcourt de formation ?",['Choisissez entre les différentes formation :','Wild Code School (2021-2022)','Université de grenoble (2006)', 'Institution saint joseph (2005)', 'Lycée'])
...
if recherche2 =='Wild Code School (2021-2022)':
	...
	recherchewild = st.select_slider("bouge le curseurs pour voir Les compétences développées :",options=['1/Collecter la donnée','2/ Traiter la donnée', '3/ Modéliser et présenter la donnée'])
	...
	recherchewild2 = st.select_slider("bouge le curseurs pour voir Les projets et hackatton:",options=['projet 1','projet 2', 'hackathon'])
	if recherchewild2 == 'projet 1':
		st.write('Projet 1: analyse de donnée et présentation Dashboard : My SQL, Tableau software ')
		st.write('le dashboard a été réalisé sur tableau software, il était interactif mais pour le partager un power point a été créer')
	...
	if recherchewild2 == 'projet 2':
		st.write("Projet 2: nettoyage, analyse et système de recommandation à partir d'une Dataframe de films : Pandas, Python, Seaborn, Power BI et Streamlit")
...
if recherche3 =='Independant immobilier chez proprietes-privees.com (2017 -2021)':
	...
	st.write("veille du marché et analyse continuelle du marché pour suivrel'évolution.")
...
recherche4 = st.selectbox("Les Plus ( langues, benevolat, loisirs)",['Choisissez le point qui vous interresse :','Langue', 'bénévolat', 'loisirs'])
if recherche4 =='Langue':
	...
	st.write("Pour l'oral je suis plus hésitant mais j'arrive a me faire comprendre, certains daily sont en anglais")
...
if recherche4 =='loisirs':
	...
	st.write("La nature, d'ou la formation de bases dans le milieu de la forêt")
	st.write("Les voyages")
...
st.markdown("<h1 style='text-align: center; color: black;font-size: 15px;'>06-74-36-45-35</h1>", unsafe_allow_html=True)
